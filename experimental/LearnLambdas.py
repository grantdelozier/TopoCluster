...
if mode == "trconll":
	...
	import TestResolver_TRCONLL as TR
	...
	it_size = 0.1
	#train_tbl = "trconllf_dev_trainsplit2_kernel100k_epanech_gi"
	#test_xml = "/home/grant/devel/TopCluster/trconllf/xml/dev_testsplit2"
	...
	while lamb_wiki <= 1.0:
		...
		TR.calc(train_tbl, out_domain_stat_tbl, test_xml, conn_info, gtbl, window, percentile, place_name_weight, country_tbl, region_tbl, state_tbl, geonames_tbl, tst_tbl, lamb_trconll, lamb_wiki, outfile)
...
if mode == "lgl":
	import TestResolver_LGL_allits as TR
	...
	out_train_tbl = "lgl_dev_trainsplit3"
